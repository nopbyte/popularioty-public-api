package popularioty.api.common.exception;
...
public class ReputationAPIException extends Exception
{
	 ...
	 */
	public ReputationAPIException(String message, Throwable cause, Logger classLogger, String loggingMessage, Level level, int HTTPErrorCode )
	{
		super(message, cause);
		this.internal = true;
	 ...
	 */
	public ReputationAPIException(String message, Logger classLogger, Map<String,Object> externalError, Level level, int HTTPErrorCode)
	{
		super(message);
		this.internal = false;
